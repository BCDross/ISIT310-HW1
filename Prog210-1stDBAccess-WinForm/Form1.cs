...
namespace Prog210_1stDBAccess_WinForm
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            listView1.Columns.Add("OrderDate", 100, HorizontalAlignment.Left);

            listView1.GridLines = true;
       

             // our 3 ADO objects for reading data from Prog123:  SqlCommand  SqlDataReader  SqlConnection
            SqlCommand selectCommand = new SqlCommand();    //sql command object
            ...
            selectCommand = new SqlCommand("SELECT c.CompanyName, o.ShipCountry, o.OrderDate FROM Customers AS c INNER JOIN Orders AS o ON c.CustomerID = o.CustomerID WHERE o.ShipCountry = 'USA' ORDER BY OrderDate ASC;", connection);
            // using the constructor that accpets the SQL command string, and the connection
            // one of several choices. Those are just properties that can be set after you
            // create the object

            //open the database connection
            selectCommand.Connection.Open();

            // define a variable of type Reader. as that is what this sql command will return
            // from the ExecuteReader method call
            ...
            while (sqlReader.Read()) // reader object returns a false when there are no more rows
            {
                ...
                listView1.Items[listView1.Items.Count - 1].SubItems.Add(sqlReader[2].ToString());
            }
